...
import type frInvitation from "./fr/invitation";
...
const loaders = {
  fr: {
    ...
    invitation: () => import("./fr/invitation").then((m) => m.default),
  ...
  en: {
    ...
    invitation: () => import("./en/invitation").then((m) => m.default),
...
export type Messages = {
  ...
  invitation: typeof frInvitation;
