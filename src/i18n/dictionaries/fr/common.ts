...
const common = {
  ...
  chatbot: {
    ...
    welcome:
      "Bonjour ! 👋 Je suis l'assistant KIYANZA. Posez-moi vos questions sur la plateforme ou sur le marketing de votre activité : vous avez 3 questions gratuites.",
    thinking: "L'assistant rédige sa réponse…",
    error: "L'assistant est momentanément indisponible. Réessayez dans quelques instants.",
    limitReached: "Vous avez atteint la limite de questions pour aujourd'hui.",
    signupCardTitle: "Des conseils adaptés à votre entreprise",
    signupCardText:
      "Créez votre compte gratuit : l'assistant connaîtra votre activité et vos campagnes, et gardera l'historique de vos échanges.",
    signupCta: "Créer mon compte gratuit",
    loginCta: "Se connecter",
    exhaustedTitle: "Vos questions gratuites sont épuisées",
    exhaustedText: "Continuez avec l'assistant complet dans votre espace KIYANZA, gratuitement.",
    remainingOne: "Plus que {count} question gratuite",
    remainingMany: "Encore {count} questions gratuites",
    loggedInTitle: "Vous êtes connecté",
    loggedInText:
      "Votre espace dispose de l'assistant complet : il connaît votre entreprise et vos campagnes, et garde l'historique de vos conversations.",
    loggedInCta: "Ouvrir l'assistant",
