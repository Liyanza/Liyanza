...
const dash = {
  ...
  copilot: {
    ...
    title: "Assistant KIYANZA",
    subtitle: "Votre copilote marketing",
    close: "Fermer l'assistant",
    newConversation: "Nouvelle conversation",
    fullScreen: "Ouvrir en plein écran",
    campaignContext: "Contexte : cette campagne",
    emptyTitle: "Comment puis-je vous aider ?",
    emptyText: "Je connais votre entreprise et vos campagnes. Posez une question ou choisissez une suggestion.",
    suggestions: [
      "Quel canal choisir pour mon activité ?",
      "Comment optimiser un petit budget publicitaire ?",
      "Quel canal a le meilleur ROAS en moyenne ?",
    ],
    campaignSuggestions: [
      "Analyse les résultats de cette campagne",
      "Comment améliorer le CTR de cette campagne ?",
      "Comment mieux répartir le budget de cette campagne ?",
    ],
    ...
    error: "L'assistant n'a pas pu répondre. Réessayez dans quelques instants.",
    noCompany: "Créez ou rejoignez une entreprise pour utiliser l'assistant.",
    ...
    disclaimer: "L'IA peut se tromper : vérifiez les informations importantes.",
    history: "Historique",
    historyEmpty: "Aucune conversation pour l'instant.",
    historyError: "Impossible de charger l'historique.",
    rename: "Renommer",
    renameLabel: "Nouveau titre de la conversation",
    delete: "Supprimer",
    ...
    analyzePrompt:
      "Analyse les résultats de cette campagne : points forts, points faibles et actions concrètes pour l'améliorer.",
  },
};
