    ...
    <div className="flex flex-wrap items-center justify-between gap-4 pb-8">
      <div className="flex items-center gap-2">
        <span className="rounded-full bg-orange-500/10 px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-[0.275px] text-orange-500">
          {fill(t.stepper.step, { current: String(stepIndex + 1).padStart(2, "0"), total })}
        </span>
        <span className="text-sm font-medium text-dash-body">{t.steps[stepIndex]}</span>
      </div>
